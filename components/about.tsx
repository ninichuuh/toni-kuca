      ...
      >
        ...
        <div className="grid grid-cols-4 gap-12 mt-16">
          <div className={clsx("col-span-4", "lg:col-span-2")}>
            <h3 className="text-2xl text-gray-700  mb-6">TEXT OVDJE</h3>
          ...
          <div className={clsx("col-span-4 text-gray-700", "lg:col-span-2")}>
            <h3 className=" text-2xl mb-6">NAZIV OVDJE</h3>
            <motion.div
              whileInView="animate"
            ...
            >
              ...
              >
                ...
                <span className="text-base">BBQ</span>
              </motion.div>
              <motion.div
                variants={SkillItem}
                className="flex flex-col  gap-2 p-2 shadow-md border-2 border-gray-200 rounded-lg items-center"
              >
                <GrOverview size={36} />
                <span className="text-base">Sea View</span>
              </motion.div>
              <motion.div
                variants={SkillItem}
                className="flex flex-col  gap-2 p-2 shadow-md border-2 border-gray-200 rounded-lg items-center"
              >
                <RiPlantLine size={36} />
                <span className="text-base">Garden</span>
              </motion.div>
              <motion.div
                variants={SkillItem}
                className="flex flex-col  gap-2 p-2 shadow-md border-2 border-gray-200 rounded-lg items-center"
              ...
              >
                <MdPool size={36} />
                <span className="text-base">SwimmingPool</span>
              </motion.div>
            </motion.div>
          </div>
        </div>
